...
export class OptionState implements NgxsOnInit {
  ...
  @Action(InitOptions)
  initOptions(ctx: StateContext<OptionStateModel>, {data}: InitOptions) {
    ctx.patchState({
      includes: data.includes,
      excludes: data.excludes,
      refines: data.refines,
      includesOptions: data.includesOptions,
      excludesOptions: data.excludesOptions,
      refinesOptions: data.refinesOptions,
    });
  }
